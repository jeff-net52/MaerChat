...
| Qualité Spotless/Lint | Partiel | Lint Debug sans nouveau constat ; 626 constats historiques restent documentés dans la baseline. Spotless et la Release signée restent à qualifier |
