...
Pour la version 0.5.4, l’identité Android reste `fr.maer.chat`, avec `minSdk` 23
et `targetSdk` 37. Le code visible attendu est `900` pour l’APK universelle et
`904` pour l’APK ARM64 : Gradle multiplie le `versionCode` 9 par 100 puis ajoute
