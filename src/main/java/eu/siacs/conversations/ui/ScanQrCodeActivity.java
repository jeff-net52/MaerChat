...
public final class ScanQrCodeActivity extends AppCompatActivity
    ...
    private final Runnable fetchAndDecodeRunnable =
            new Runnable() {
                ...
                private void decode(final byte[] data) {
                    ...
                    try {
                        hints.put(
                                ...
                                (ResultPointCallback)
                                        dot -> runOnUiThread(() -> scannerView.addDot(dot)));
            ...
            new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        final RectF framingRectInPreview =
                                new RectF(cameraManager.getFramePreview());
                        framingRectInPreview.offsetTo(0, 0);
                        final boolean cameraFlip =
                                cameraManager.getFacing() == CameraInfo.CAMERA_FACING_FRONT;
                ...
                private int displayRotation() {
                    ...
                    else if (rotation == Surface.ROTATION_90) return 90;
                    else if (rotation == Surface.ROTATION_180) return 180;
                    else if (rotation == Surface.ROTATION_270) return 270;
                    else throw new IllegalStateException("rotation: " + rotation);
                }
            };
