...
public abstract class AbstractPhoneContact {
    ...
    AbstractPhoneContact(Cursor cursor) {
        int phoneId = cursor.getInt(cursor.getColumnIndexOrThrow(ContactsContract.Data._ID));
        String lookupKey =
        ...
        this.photoUri =
                cursor.getString(cursor.getColumnIndexOrThrow(ContactsContract.Data.PHOTO_URI));
    }
